    ...
    <main className="min-h-screen bg-[#050505] text-gray-100 flex flex-col items-center py-24 px-6">
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-gray-900/30 border border-gray-800 rounded-3xl p-8 flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold">Mîkāt-ı Nur Android APK</h2>
            <p className="text-gray-400 mt-2">En güncel sürüm (v1.1.0)</p>
          </div>
          
          {/* GitHub Latest Release Linki */}
          <a 
            href="https://github.com/bytuna/MikatiNur/releases/download/v1.1.0/Mikat-Nur-v1.1.0.apk" 
        ...
        <p className="text-gray-400 mt-2">⚠️ Dikkat: Uygulamayı yüklerken "Riskli olabilir" uyarısı alabilirsiniz. Bu, uygulama Google Play Store dışında bir yerden (GitHub gibi) yüklendiği için Android'in verdiği standart bir uyarıdır.
        </p>
        <p className="text-gray-400 mt-2">🚀 Not: Bilinmeyen kaynaklardan uygulama yükleme iznini açmayı unutmayınız.
        </p>
